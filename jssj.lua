...
Fluent:RegisterCustomTheme("Dark", {
    ...
    ElementBorder = Color3.fromRGB(215, 215, 215),
    InElementBorder = Color3.fromRGB(200, 200, 200),
    ElementTransparency = 0,

    ToggleSlider = Color3.fromRGB(205, 205, 205),
    ...
    InputIndicator = Color3.fromRGB(190, 190, 190),
    ...
    DialogInputLine = Color3.fromRGB(190, 190, 190),
    ...
    Shine = {
        Speed = 0,
        RotationSpeed = 0,
        ColorSequence = ColorSequence.new(Color3.fromRGB(255, 255, 255), Color3.fromRGB(245, 245, 245)),
    },
    StrokeShine = false,
    ...
    Background = "rbxassetid://121601063984387",
...
-- AppleMeoMeo: white UI / black text
pcall(function()
    ...
    if root then
        local function apply(obj)
            ...
            elseif obj:IsA("Frame") or obj:IsA("ScrollingFrame") then
                if obj.BackgroundTransparency < 1 then obj.BackgroundColor3 = Color3.fromRGB(255,255,255) end
            end
        end
        for _,o in ipairs(root:GetDescendants()) do apply(o) end
    end
end)
...
-- AppleMeoMeo rainbow image border
task.spawn(function()
    local RunService = game:GetService("RunService")
    local hue = 0
    while task.wait() do
        ...
        if root then
            for _, obj in ipairs(root:GetDescendants()) do
                if obj:IsA("ImageLabel") and obj.Image == "rbxassetid://121601063984387" then
...
Fluent:Notify({
  Title = "AppleMeoMeo/System",
  Content = "Welcome To AppleMeoMeo",
