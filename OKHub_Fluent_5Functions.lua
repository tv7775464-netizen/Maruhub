...
local Tabs = {
    Info = wrapTab(Window:AddTab({ Title = "Tab Info And Status", Icon = "Info" })),
...
local ScriptImage = "rbxassetid://122325089010707"
...
-- UI framework: Fluent (original OK Hub base)
