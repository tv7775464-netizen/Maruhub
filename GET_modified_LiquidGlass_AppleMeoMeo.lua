...
local Themes = {
	...
	["Midnight Blue"] = {
	    Name = "Midnight Blue",
	    Accent = Color3.fromRGB(95, 190, 255),
	
		AcrylicMain = Color3.fromRGB(28, 115, 195),
	    AcrylicBorder = Color3.fromRGB(185, 230, 255),
	    AcrylicGradient = ColorSequence.new(Color3.fromRGB(80, 180, 255), Color3.fromRGB(15, 70, 145)),
	    AcrylicNoise = 0.88,
	
	    TitleBarLine = Color3.fromRGB(165, 225, 255),
	    Tab = Color3.fromRGB(130, 130, 140),
	
		Element = Color3.fromRGB(25, 105, 180),
		ElementBorder = Color3.fromRGB(125, 210, 255),
		InElementBorder = Color3.fromRGB(180, 235, 255),
		ElementTransparency = 0.28,
	
	    ToggleSlider = Color3.fromRGB(120, 210, 255),
	    ToggleToggled = Color3.fromRGB(40, 120, 205),
	
	    SliderRail = Color3.fromRGB(90, 165, 220),
	
	    DropdownFrame = Color3.fromRGB(24, 100, 175),
	    DropdownHolder = Color3.fromRGB(18, 75, 140),
	    DropdownBorder = Color3.fromRGB(145, 220, 255),
	    DropdownOption = Color3.fromRGB(220, 245, 255),
	
	    Keybind = Color3.fromRGB(25, 100, 175),
	
	    Input = Color3.fromRGB(20, 85, 155),
	    InputFocused = Color3.fromRGB(30, 115, 195),
	    InputIndicator = Color3.fromRGB(120, 215, 255),
	    InputIndicatorFocus = Color3.fromRGB(160, 230, 255),
	
	    Dialog = Color3.fromRGB(22, 90, 160),
	    DialogHolder = Color3.fromRGB(18, 75, 140),
	    DialogHolderLine = Color3.fromRGB(130, 210, 250),
	    DialogButton = Color3.fromRGB(25, 105, 180),
	    DialogButtonBorder = Color3.fromRGB(150, 225, 255),
	    DialogBorder = Color3.fromRGB(175, 230, 255),
	    DialogInput = Color3.fromRGB(20, 85, 155),
	    DialogInputLine = Color3.fromRGB(130, 220, 255),
	
	    Text = Color3.fromRGB(245, 250, 255),
	    SubText = Color3.fromRGB(195, 230, 250),
	    Hover = Color3.fromRGB(70, 160, 225),
	    HoverChange = 0.04,
	},
	["Amethyst Maru"] = {
		Name = "Amethyst Maru",
...
Components.TitleBar = function(Config)
	...
	TitleBar.Frame = New("Frame", {
		...
		New("ImageLabel", {
			Image            = "rbxassetid://138770682187300",
			Size             = UDim2.fromOffset(20, 20),
			AnchorPoint      = Vector2.new(0, 0.5),
...
Components.Window = (function()
	...
	return function(Config)
		...
		local GlassWash = New("Frame", {
		    Name = "AppleMeoMeoGlassWash",
		    Size = UDim2.fromScale(1, 1),
		    Position = UDim2.fromScale(0, 0),
		    BackgroundColor3 = Color3.fromRGB(40, 145, 225),
		...
		local FrontLogo = New("ImageLabel", {
		    Name = "AppleMeoMeoFrontLogo",
		    Image = "rbxassetid://102474029927884",
		...
		Window.TitleBar = Components.TitleBar({
			...
			Icon = "rbxassetid://126048951669906",
			Parent = Window.Root,
			Window = Window,
		})
...
function Library:CreateWindow(Config)
	...
	Library.Theme = (Config.Theme == "Darker" or not Config.Theme) and "Midnight Blue" or Config.Theme
	...
	-- 		}),
	-- 		New("ImageLabel", {
	-- 			Image = Config.MinimizerIcon or "rbxassetid://138770682187300",
	-- 			Size = UDim2.new(1, 0, 1, 0),
	-- 			BackgroundTransparency = 1,
	-- 		}, {
	-- 			New("UIAspectRatioConstraint", {
